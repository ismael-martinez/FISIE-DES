...
def state_update(env):
    ...
    strat_collateral_avg = np.nan
    if len(strat_fog_collateral) > 0:
        strat_collateral_avg = np.mean(strat_fog_collateral)
